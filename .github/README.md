...
[`@aws-sdk/client-codeartifact`](https://www.npmjs.com/package/@aws-sdk/client-codeartifact/v/3.29.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-codeartifact@3.29.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Wu67rsIgnmVi1iRgc9UP3DBUJcldt53PboSTIbAPGe69mS/RsCLes0cvgu56lcon
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-codeartifact": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-codeartifact@3.29.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-codeartifact@3.29.0/index.min.mjs": "sha384-Wu67rsIgnmVi1iRgc9UP3DBUJcldt53PboSTIbAPGe69mS/RsCLes0cvgu56lcon"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-codeartifact/blob/refs/tags/3.29.0/LICENSE
```
