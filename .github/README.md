...
[`@aws-sdk/client-codeartifact`](https://www.npmjs.com/package/@aws-sdk/client-codeartifact/v/3.991.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-codeartifact@3.991.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-GKlyRxeAdESP+vq9EOcaf1ZcR36xyVF6F6/Av1Ctl0t1PVJETDoWZQkH0zkObIff
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-codeartifact": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-codeartifact@3.991.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-codeartifact@3.991.0/index.min.mjs": "sha384-GKlyRxeAdESP+vq9EOcaf1ZcR36xyVF6F6/Av1Ctl0t1PVJETDoWZQkH0zkObIff"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-codeartifact/blob/refs/tags/3.991.0/LICENSE
```
